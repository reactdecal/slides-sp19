...
<div style={{ display: "flex", justifyContent: "center" }}>
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/ethan.png" width="200" height="200" style={{borderRadius: '100%', margin: '20px 20px 0px 20px'}}/>
    <h4>Ethan Lee</h4>
  </div>
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/aivant.png" width="200" height="200" style={{borderRadius: '100%', margin: '20px 20px 0px 20px'}}/>
    <h4>Aivant Goyal</h4>
  </div>
</div>
...
<div style={{display: "flex", flexWrap: "wrap", justifyContent: "center"}} >
  ...
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/kirby.png" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Zachary Kirby</h4>
  </div>
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/selina.jpeg" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Selina Feng</h4>
  </div>
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/wilson.png" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Wilson Wang</h4>
  </div>
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/adhiv.jpg" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Adhiv Dhar</h4>
  </div>
...
<div style={{display: "flex", flexWrap: "wrap", justifyContent: "center"}} >
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/amitav.jpg" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Amitav Baruah</h4>
  </div>
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/alejandro.jpeg" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Alejandro Garcia Salas</h4>
  </div>
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/isabelle.jpg" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Isabelle Zhou</h4>
  </div>
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/linus.jpeg" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Linus Lee</h4>
  </div>
...
<div style={{display: "flex", flexWrap: "wrap", justifyContent: "center"}} >
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/brenda.jpeg" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Brenda Zhang</h4>
  </div>
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/trevor.jpg" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Trevor Aquino</h4>
  </div>
  <div style={{display: "flex", flexDirection: "column", height: "100px", alignItems: "center", margin: '0px 20px 0px 20px'}}>
    <img src="../assets/images/TAs/arpan.png" width="175" height="175" style={{borderRadius: "100%", margin: "20px"}}/>
    <h4>Arpan Pal</h4>
  </div>
