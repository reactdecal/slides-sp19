...
<div className="codesurfer">
  <CodeSurfer
    ...
    steps={[
      ...
      {
        lines: [3, 4, 5, 6],
        notes: "This is how we describe how our view will look using JSX. It's not HTML!"
      },
      {
        tokens: {
          4: [5, 6, 7, 8, 9],
        },
        notes: "We can execute javascript in JSX using {} to help us render the component"
      },
      {
        tokens: {
          1: [6, 7, 8],
...
<div className="codesurfer">
  <CodeSurfer
    ...
    steps={[
      ...
      { notes: "React will take this Component and call the function we defined!", 
        tokens: { 
            2: [4, 5, 6, 7]
        }
      }
